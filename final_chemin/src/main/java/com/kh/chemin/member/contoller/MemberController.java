...
public class MemberController {
  ...
  @RequestMapping("/member/memberInfoUpdate")
   public String memberInfoUpdate(Member member, String address1, String address2, String address3,MultipartFile orImg, HttpServletRequest request,Model model){
