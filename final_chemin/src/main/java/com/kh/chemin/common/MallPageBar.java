...
public class MallPageBar {
	...
	public static String getPageAdmin(int cPage, int numPerPage, int totalContents)
	   {
	      String pageBar="";
	      int pageBarSize=5;
	...
	public static String getPageAdminMember(int cPage, int numPerPage, int totalContents)
	   {
	      String pageBar="";
	      int pageBarSize=5;
