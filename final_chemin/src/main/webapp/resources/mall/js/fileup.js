...
var FileUploadWithPreview = function () {
    function FileUploadWithPreview(uploadId) {
        ...
        this.el = document.querySelector('.file_container[data-upload-id="' + this.uploadId + '"]');
        if (!this.el) {
            throw new Error('Could not find a `file_container` with the id of: ' + this.uploadId);
        }
        this.input = this.el.querySelector('input[type="file"]');
        this.inputLabel = this.el.querySelector('.imgControl');
        this.imagePreview = this.el.querySelector('.imgPreview');
        this.clearButton = this.el.querySelector('.imgClear');
