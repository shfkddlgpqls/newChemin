		...
		<div class="container">
			<div class="row justify-content-center">
                <div class="col-md-8 p-b-30" style="padding-right: 5%">
					<form class="leave-comment customfileinput" name="productFrm" action="${path }/admin/productEnroll.do" enctype="multipart/form-data" method="post">
						...
						<table style="width: 100%;height: 100%;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="bo4 of-hidden size15 m-b-20">
                                        <input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="pName" id="pName" placeholder="등록할 상품명" required>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="bo4 of-hidden m-b-20" style="height: 192px;">
                                    	<textarea class="sizefull s-text7 p-l-22 p-r-22 p-t-10 p-b-10" name="details" id="details" placeholder="상품의 상세 설명" style="width:100%;resize:none;" rows="8" required></textarea>
                                    </div>
                                </td>
                            </tr>
                            <tr>
	                                ...
	                                <div class="file_container" data-upload-id="imgUpLoad">
		                                <div class="bo4 of-hidden size15 m-b-20">
							                <label class="imgfileUp" >
							                    <input type="file" id="mainImg" name="mainImg" class="sizefull s-text7 p-l-22 p-r-22 imgInput" accept="image/*" required/>
							                    <span class="imgControl"></span>
							                </label>
						                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="bo4 of-hidden size15 m-b-20">
                                        <input class="sizefull s-text7 p-l-22 p-r-22" type="number" name="price" id="price" min="0" placeholder="판매 가격" required>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="bo4 of-hidden size15 m-b-20">
                                        <input class="sizefull s-text7 p-l-22 p-r-22" type="number" name="pCount" id="pCount" min="0" placeholder="현재 재고" required>
                                    </div>
                                </td>
                            </tr>
                            <tr>
